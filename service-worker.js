...
const CACHE_VERSION = 'finance-v8';
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate' || url.endsWith('index.html') || url.endsWith('/') ||
      url.includes('app.js') || url.includes('charts.js') || url.includes('github.js') || url.includes('sinking.js') || url.includes('budget.js') || url.includes('savings.js') || url.includes('styles.css')) {
    e.respondWith(
      fetch(e.request)
        .then(res => {
